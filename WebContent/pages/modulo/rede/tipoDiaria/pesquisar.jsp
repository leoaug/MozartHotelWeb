...
<script>
  ...
  <s:form action="pesquisarTipoDiaria!pesquisar.action" namespace="/app/rede" theme="simple" >
    ...
    <div class="divFiltroPaiTop">Tipo Diária</div>    
 ...
 <!-- grid -->
    ...
    <duques:grid colecao="listaPesquisa" titulo="Relatório Tipo de Diária" 
        ...
        <duques:column labelProperty="Descrição"       propertyValue="descricao" 		style="width:200px;" />
        <duques:column labelProperty="Padrão"     	   propertyValue="padrao"        	style="width:80px;" />

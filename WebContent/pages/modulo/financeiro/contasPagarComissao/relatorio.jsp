...
<s:form action="pesquisarContasPagarComissao!prepararPesquisa.action" namespace="/app/financeiro" theme="simple">
<div class="divFiltroPaiTop">Contas a pagar Comissão</div>

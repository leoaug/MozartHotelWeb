...
<s:form namespace="/app/financeiro" action="encerrarTesouraria!encerrar.action" theme="simple">
...
<div class="divFiltroPai" >
        <div class="divCadastro" style="overflow:auto;" >
     		 ...
     		 <div class="divGrupo" style="height:200px;">
                ...
                <div class="divLinhaCadastro">
                    <div class="divItemGrupo" style="width:300px;" ><p style="width:250px;color:black;">Data contas pagar: </p>
                    	<s:if test="%{#session.CONTROLA_DATA_SESSION.contasPagar.compareTo(#session.CONTROLA_DATA_SESSION.tesouraria) <= 0}">
                    		<img src="imagens/iconic/png/xRed-3x.png" title='Data Contas a Pagar é menor a da Tesouraria.' >
                    	</s:if>
                    	<s:else>
                    		<img src="imagens/msgSucesso.png" title="Data Contas a Pagar é maior a da Tesouraria." ></img>
                    	</s:else>
                    </div>
                </div>
                ...
                <div class="divLinhaCadastro">
                    <div class="divItemGrupo" style="width:300px;" ><p style="width:250px;color:black;">Data contas receber: </p>
                    	<s:if test="%{#session.CONTROLA_DATA_SESSION.contasReceber.compareTo(#session.CONTROLA_DATA_SESSION.tesouraria) <= 0}">
                    		<img src="imagens/iconic/png/xRed-3x.png" title='Data Contas a Receber é menor a da Tesouraria.' >
                    	</s:if>
                    	<s:else>
                    		<img src="imagens/msgSucesso.png" title="Data Contas a Receber é maior a do Tesouraria." ></img>
                    	</s:else>
                    </div>
                </div>
             ...
             <div class="divCadastroBotoes">
                    ...
                    <s:if test="%{#session.CONTROLA_DATA_SESSION.contasPagar.compareTo(#session.CONTROLA_DATA_SESSION.tesouraria) > 0 && #session.CONTROLA_DATA_SESSION.contasReceber.compareTo(#session.CONTROLA_DATA_SESSION.tesouraria) > 0 }">

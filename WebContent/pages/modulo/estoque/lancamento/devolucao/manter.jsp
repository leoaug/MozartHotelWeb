...
function gravar() {
	...
	if ($("input[name='idCentroCusto']").val() == '') {
...
function podeGravar() {
	vForm = document.forms[0];
	vForm.action = '<s:url action="entradaDevolucaoEstoque!salvarDevolucao.action" namespace="/app/estoque" />';
	submitForm(vForm);
}
...
$(document).ready(function(){
    $(".idCentroCusto").change(function(){
    	document.getElementById('idLancamentoFrame').contentWindow.location.reload(true);
    });
});
</script>

<s:form action="entradaDevolucaoEstoque!salvarDevolucao.action" theme="simple"
	...
	<!-- divHistorico -->
	<div class="divFiltroPaiTop">Estoque - Devolução</div>
	<div class="divFiltroPai">
		...
		<div class="divCadastro" style="overflow: auto; height: 200%;">
			...
			<div class="divGrupo" style="height: 105px;">
				...
				<div class="divLinhaCadastro">
					...
					<div class="divItemGrupo" style="width: 250px;">
						<p style="width: 120px;">Data devolução</p>
						<s:textfield 
				...
				<div class="divLinhaCadastro">
					<div class="divItemGrupo" style="width: 250px;">
						<p style="width: 120px;">Total da Devolução</p>
						<s:textfield 
							disabled="true"
							readonly="true"
			...
			<div id="gridLancamento" class="divGrupo" style="width:99%; height:270px;">
				<div class="divGrupoTitulo" style="float:left;">Dados da Devolução</div>
				<iframe width="100%" height="220" id="idLancamentoFrame" scrolling="no" 
						frameborder="0" marginheight="0" marginwidth="0" 
						src="<s:url value="app/estoque/includeDevolucao!prepararLancamentoSaida.action"/>?time=<%=new java.util.Date()%>"  >
				</iframe>
			</div>
			<!-- Fim Grupo Grid -->

...
<script type="text/javascript">
	...
	function consultarCorporate() {
		...
		//document.forms[0].action = '<s:url action="manter!consultarCorporate.action" namespace="/app/reserva" />'        
	...
	function validarGravarReserva() {
		...
		if (document.getElementById('ehAlteracao').value != "true" && pegaDiferencaDiasDatas('<s:property value="#session.CONTROLA_DATA_SESSION.frontOffice"/>' ,document.getElementById('reservaVO.bcDataEntrada').value) > 0){
			erro += '- O Data Inicial do Período deve ser maior ou igual a Controla data.';
		}
		...
		if (erro != '')
			...
			submitFormAjax('validarGravacaoReserva?ehAlteracao=' + document.getElementById('ehAlteracao').value, true);
		}
	...
	function cancelarReserva() {
		...
		document.forms[0].action = '<s:url namespace="/app/reserva" action="pesquisar" method="prepararPesquisa" />';
		submitForm(document.forms[0]);
	}

	function confirmarReserva(msg) {
		//document.forms[0].action = '<s:url namespace="/app/reserva" action="manter" method="salvarReserva" />';                
		if (confirm(msg)){
			salvarReserva();
        }
	}
	...
	function verificaDatasERecalculaTarifas() {
		...
		if (document.getElementById('reservaVO.bcDataEntrada').value == ''){
			alert('Insira a data de entrada');
			return false;
		}
		if (pegaDiferencaDiasDatas('<s:property value="#session.CONTROLA_DATA_SESSION.frontOffice"/>' ,document.getElementById('reservaVO.bcDataEntrada').value) > 0){
			alert('O Data Inicial do Período deve ser maior ou igual a Controla data.');
			document.getElementById('reservaVO.bcDataEntrada').value = '<s:property value="#session.CONTROLA_DATA_SESSION.frontOffice"/>';
			return false;
		}
		...
		if (document.getElementById(campoDataEntrada).value != ''
				&& document.getElementById(campoDataSaida).value != '') {
			loading();
			submitFormAjax('validaERecalculaTarifas?dataEntrada='
					+ document.getElementById(campoDataEntrada).value
					+ '&dataSaida='
	...
	function atualizarResAptoRL() {
		...
		//document.getElementById('idResAptoFrame').src = document.getElementById('idResAptoFrame').src;        
	}
	...
	function mudarHotelCRS() {
		document.forms[0].action = '<s:url namespace="/app/reserva" action="manter" method="preparaManterCRS" />';
		submitForm(document.forms[0]);
	}
...
<s:form namespace="/app/reserva" action="manter!salvarReserva" theme="simple">
...
<div class="divFiltroPaiTop">Cadastro de Reserva</div>
            ...
            <div id="divHospedeModal"  class="divCadastro" style="display:none;height:200px;width:650px;">       
             <div class="divGrupo" style="width:98%; height:130px">
                <div class="divGrupoTitulo">Dados do hóspedes</div>
                    ...
                    <iframe width="100%" height="70px;" id="idResHospede" frameborder="0" marginheight="0" marginwidth="0" src="<s:url value="app/reserva/include!prepararHospede.action"/>?time=<%=new java.util.Date()%>"  ></iframe> 
             </div>          
...
<!--final-->
            <!--Inicio reserva apartamento diaria-->
              <div id="divDiariasModal" class="divCadastro" style="height:550px; width:650px;  display:none;">
              	<div class="divGrupo" style="height:450px">
	                ...
	                <iframe width="630px" height="400px;" id="iDiarias" scrolling="yes" frameborder="0" marginheight="0" marginwidth="0" src="<s:url value="app/reserva/include!prepararDiarias.action"/>?time=<%=new java.util.Date()%>"  ></iframe>
	            </div>                    
              ...
              <div id="divRoomListModal" class="divCadastro" style="height:520px; width:900px;  display:none;">
                  <div class="divGrupo" style="height:430px">
		               <div class="divGrupoTitulo">Room List</div>
		                ...
		                <iframe width="100%" height="315px;" id="iRoomList" scrolling="yes" frameborder="0" marginheight="0" marginwidth="0" src="<s:url value="app/reserva/include!prepararRoomList.action"/>?time=<%=new java.util.Date()%>"  ></iframe>
					</div> 
            ...
            <!--Início dados da reserva -->
             <div class="divGrupo" style="width:99%; height:140px">
                <div class="divGrupoTitulo">Dados da reserva</div>
                ...
                <div class="divLinhaCadastro">
                    <div class="divItemGrupo" style="width:310pt;" ><p>Empresa:</p>                         
                        <s:textfield onblur="getEmpresa(this); getBloqueio();" id="empresaHotelVO.bcNomeFantasia" name="empresaHotelVO.bcNomeFantasia" size="45" maxlength="50" />
                    </div>
					...
					<s:else>
					<div id="divGrupoReserva" class="divItemGrupo" style="width:130pt;" >
                ...
                <div class="divLinhaCadastro">
                    <div class="divItemGrupo" style="width:310pt;" ><p>Corporate:</p>                         
                        <s:textfield onblur="getCorporate(this)" name="empresaHotelVO.bcCorporate" id="empresaHotelVO.bcCorporate" size="45" maxlength="50"/>
                    </div>
                    ...
                    <div class="divItemGrupo" style="width:128pt;" ><p style="width:55pt;">Tipo mídia:</p> 
                        <s:select id="reservaVO.bcIdReservaMida" name="reservaVO.bcIdReservaMida" list="#session.ListaTipoMidia" cssStyle="width:60pt" listKey="id" listValue="value" value="reservaVO.bcIdReservaMida"/>
                    </div>
                ...
                <div class="divLinhaCadastro">
                    ...
                    <div class="divItemGrupo" style="width:137pt;" ><p style="width:66pt;">Deadline:</p>                                 
              ...
              <div id="divReservaApartamento" class="divGrupo" style="width:99%; height:275px;">
                ...
                <iframe width="100%" height="220" id="idResAptoFrame" scrolling="no" frameborder="0" marginheight="0" marginwidth="0" src="<s:url value="app/reserva/include!prepararReservaApto.action"/>?time=<%=new java.util.Date()%>"  ></iframe> 
                <div class="divLinhaCadastro">
              ...
              <div class="divGrupo" style="width:99%; height:50px">
                <div class="divGrupoTitulo">Total reserva</div>
                <div class="divLinhaCadastro">                    
              ...
              <div class="divGrupo" style="width:99%; height:270px">
                ...
                <iframe width="100%" height="230px;" id="idPagamentoReserva" scrolling="no" frameborder="0" marginheight="0" marginwidth="0" src="<s:url value="app/reserva/include!prepararReservaPagamento.action"/>?time=<%=new java.util.Date()%>"  ></iframe>  
              </div>
              <!--Fim dados pagamento-->                        
             ...
             <div class="divGrupo" style="width:99%; height:110px">
                ...
                <div class="divLinhaCadastro">
                    <div class="divItemGrupo" style="width:320pt;" ><p>Contato:</p> 
                        <s:textfield id="reservaVO.bcContato" name="reservaVO.bcContato" size="45" maxlength="30" />
                    </div>
                ...
                <div class="divLinhaCadastro">
                 ...
                 <div class="divLinhaCadastro">
                    <div class="divItemGrupo" style="width:320pt;" ><p>Cidade:</p>                             
                            <s:textfield disabled="true" id="empresaHotelVO.bcCidade" name="empresaHotelVO.bcCidade" size="45" maxlength="50" />
                    </div>
        ...
        <!--Início despesas -->
             <div class="divGrupo" style="width:99%; height:200px;">

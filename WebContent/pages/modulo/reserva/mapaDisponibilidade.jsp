...
<script type="text/javascript">
            ...
            function reservar(idHotel, idTarifa, tipoApto){
				...
				vForm = document.forms[0];
				vForm.action = '<s:url action="manter!pesquisarMapa.action" namespace="/app/reserva" />';
...
<s:form namespace="/app/reserva" action="manterMapa!pesquisarMapa.action" theme="simple">

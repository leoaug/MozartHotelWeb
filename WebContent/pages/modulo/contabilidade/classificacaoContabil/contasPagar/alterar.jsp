...
<s:form namespace="/app/contabilidade"
	action="manterClassificacaoContabilCPagar!alterarClassificacaoContabil"
	theme="simple">
				...
				<s:if
					...
					<div class="divLinhaCadastro"
						...
						<div class="divItemGrupo" style="width: 70%; height: 20px">
							<p>Débito:</p>
							<s:textfield style="width: 550px;" onblur="getCredito(this, 'pagJurEjb.credito')"
			...
			<div class="divGrupo" style="width: 98%; height: 102px">
				...
				<s:if
					...
					<div class="divLinhaCadastro"
						...
						<div class="divItemGrupo" style="width: 70%; height: 20px">
							<p>Débito:</p>
							<s:textfield style="width: 550px;" onblur="getDebito(this, 'pagAjuEjb.debito')"
				...
				<s:if
					...
					<div class="divLinhaCadastro"
						...
						<div class="divItemGrupo" style="width: 70%; height: 20px">
							<p>Crédito:</p>
							<s:textfield style="width: 550px;" onblur="getCredito(this, 'pagAjuEjb.credito')"
			...
			<div class="divGrupo" style="width: 98%; height: 102px">
				...
				<s:if
					...
					<div class="divLinhaCadastro"
						...
						<div class="divItemGrupo" style="width: 70%; height: 20px">
							<p>Débito:</p>
							<s:textfield style="width: 550px;" onblur="getDebito(this, 'pagComEjb.debito')"
				...
				<s:if
					...
					<div class="divLinhaCadastro"
						...
						<div class="divItemGrupo" style="width: 70%; height: 20px">
							<p>Crédito:</p>
							<s:textfield style="width: 550px;" onblur="getCredito(this, 'pagComEjb.credito')"
			...
			<div class="divGrupo" style="width: 98%; height: 102px">
				...
				<s:if
					...
					<div class="divLinhaCadastro"
						...
						<div class="divItemGrupo" style="width: 70%; height: 20px">
							<p>Débito:</p>
							<s:textfield style="width: 550px;" onblur="getDebito(this, 'pagForEjb.debito')"
				...
				<s:if
					...
					<div class="divLinhaCadastro"
						...
						<div class="divItemGrupo" style="width: 70%; height: 20px">
							<p>Crédito:</p>
							<s:textfield style="width: 550px;" onblur="getCredito(this, 'pagForEjb.credito')"

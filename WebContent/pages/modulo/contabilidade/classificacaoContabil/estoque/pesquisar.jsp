...
<script>
	...
	function prepararAlteracao(){
		...
		vForm.action = '<s:url action="manterClassificacaoContabilEstoque!prepararAlteracao.action" namespace="/app/contabilidade" />';
		submitForm( vForm );
	}
	...
	function prepararInclusao(){
		vForm = document.forms[0];
		vForm.action = '<s:url action="manterClassificacaoContabilEstoque!prepararInclusao.action" namespace="/app/contabilidade" />';
		submitForm( vForm );
	}
		
    with(milonic=new menuname("estoque")){
        margin=3;
        style=contextStyle;
        top="offset=2";
 	...
 	<%
       String titulo = "Configuração Classificação Contábil Estoque";
  ...
  <s:form action="manterClassificacaoContabilEstoque!pesquisar.action" namespace="/app/contabilidade" theme="simple" >
 ...
 <!-- grid -->     
    <duques:grid colecao="listaPesquisa" titulo="<%=titulo%>"
				 ...
				 urlRetorno="pages/modulo/contabilidade/classificacaoContabil/estoque/pesquisar.jsp">

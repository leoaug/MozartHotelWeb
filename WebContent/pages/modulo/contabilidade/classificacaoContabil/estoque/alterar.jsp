...
<s:form namespace="/app/contabilidade"
	action="manterClassificacaoContabilEstoque!alterarClassificacaoContabil"
	theme="simple">
				...
				<s:if
					...
					<div class="divLinhaCadastro"
						...
						<div class="divItemGrupo" style="width: 70%; height: 20px">
							<p>Débito:</p>
							<s:textfield style="width: 550px;" onblur="getCredito(this, 'estEstEjb.credito')"
			...
			<div class="divGrupo" style="width: 98%; height: 102px">
				...
				<s:if
					...
					<div class="divLinhaCadastro"
						...
						<div class="divItemGrupo" style="width: 70%; height: 20px">
							<p>Débito:</p>
							<s:textfield style="width: 550px;" onblur="getDebito(this, 'estForEjb.debito')"
				...
				<s:if
					...
					<div class="divLinhaCadastro"
						...
						<div class="divItemGrupo" style="width: 70%; height: 20px">
							<p>Crédito:</p>
							<s:textfield style="width: 550px;" onblur="getCredito(this, 'estForEjb.credito')"

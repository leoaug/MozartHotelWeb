...
<script>
	...
	function prepararAlteracao(){
		...
		vForm.action = '<s:url action="manterClassificacaoContabilCReceber!prepararAlteracao.action" namespace="/app/contabilidade" />';
		submitForm( vForm );
	}
	...
	function prepararInclusao(){
		vForm = document.forms[0];
		vForm.action = '<s:url action="manterClassificacaoContabilCReceber!prepararInclusao.action" namespace="/app/contabilidade" />';
		submitForm( vForm );
	}
    ...
    with(milonic=new menuname("faturamento")){
 	...
 	<%
       String titulo = "Configuração Classificação Contábil Contas a Receber";
  ...
  <s:form action="manterClassificacaoContabilCReceber!pesquisar.action" namespace="/app/contabilidade" theme="simple" >
 ...
 <!-- grid -->     
    <duques:grid colecao="listaPesquisa" titulo="<%=titulo%>"
				 ...
				 urlRetorno="pages/modulo/contabilidade/classificacaoContabil/contasReceber/pesquisar.jsp">

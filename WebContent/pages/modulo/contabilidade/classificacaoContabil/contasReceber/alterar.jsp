...
<s:form namespace="/app/contabilidade"
	action="manterClassificacaoContabilCReceber!alterarClassificacaoContabil"
	theme="simple">
				...
				<s:if
					...
					<div class="divLinhaCadastro"
						...
						<div class="divItemGrupo" style="width: 70%; height: 20px">
							<p>Credito:</p>
							<s:textfield style="width: 550px;" onblur="getCredito(this, 'recRecEjb.credito')"
			...
			<div class="divGrupo" style="width: 98%; height: 102px">
				...
				<s:if
					...
					<div class="divLinhaCadastro"
						...
						<div class="divItemGrupo" style="width: 70%; height: 20px">
							<p>Débito:</p>
							<s:textfield style="width: 550px;" onblur="getDebito(this, 'recJurEjb.debito')"
				...
				<s:if
					...
					<div class="divLinhaCadastro"
						...
						<div class="divItemGrupo" style="width: 70%; height: 20px">
							<p>Credito:</p>
							<s:textfield style="width: 550px;" onblur="getCredito(this, 'recJurEjb.credito')"
			...
			<div class="divGrupo" style="width: 98%; height: 102px">
				...
				<s:if
					...
					<div class="divLinhaCadastro"
						...
						<div class="divItemGrupo" style="width: 70%; height: 20px">
							<p>Débito:</p>
							<s:textfield style="width: 550px;" onblur="getDebito(this, 'recDupEjb.debito')"
				...
				<s:if
					...
					<div class="divLinhaCadastro"
						...
						<div class="divItemGrupo" style="width: 70%; height: 20px">
							<p>Credito:</p>
							<s:textfield style="width: 550px;" onblur="getCredito(this, 'recDupEjb.credito')"
			...
			<div class="divGrupo" style="width: 98%; height: 102px">
				...
				<s:if
					...
					<div class="divLinhaCadastro"
						...
						<div class="divItemGrupo" style="width: 70%; height: 20px">
							<p>Débito:</p>
							<s:textfield style="width: 550px;" onblur="getDebito(this, 'recFinEjb.debito')"
				...
				<s:if
					...
					<div class="divLinhaCadastro"
						...
						<div class="divItemGrupo" style="width: 70%; height: 20px">
							<p>Credito:</p>
							<s:textfield style="width: 550px;" onblur="getCredito(this, 'recFinEjb.credito')"
			...
			<div class="divGrupo" style="width: 98%; height: 102px">
				...
				<s:if
					...
					<div class="divLinhaCadastro"
						...
						<div class="divItemGrupo" style="width: 70%; height: 20px">
							<p>Débito:</p>
							<s:textfield style="width: 550px;" onblur="getDebito(this, 'recRddEjb.debito')"
				...
				<s:if
					...
					<div class="divLinhaCadastro"
						...
						<div class="divItemGrupo" style="width: 70%; height: 20px">
							<p>Credito:</p>
							<s:textfield style="width: 550px;" onblur="getCredito(this, 'recRddEjb.credito')"
			...
			<div class="divGrupo" style="width: 98%; height: 102px">
				...
				<s:if
					...
					<div class="divLinhaCadastro"
						...
						<div class="divItemGrupo" style="width: 70%; height: 20px">
							<p>Débito:</p>
							<s:textfield style="width: 550px;" onblur="getDebito(this, 'recDreEjb.debito')"
				...
				<s:if
					...
					<div class="divLinhaCadastro"
						...
						<div class="divItemGrupo" style="width: 70%; height: 20px">
							<p>Credito:</p>
							<s:textfield style="width: 550px;" onblur="getCredito(this, 'recDreEjb.credito')"
			...
			<div class="divGrupo" style="width: 98%; height: 102px">
				...
				<s:if
					...
					<div class="divLinhaCadastro"
						...
						<div class="divItemGrupo" style="width: 70%; height: 20px">
							<p>Débito:</p>
							<s:textfield style="width: 550px;" onblur="getDebito(this, 'recDraEjb.debito')"
				...
				<s:if
					...
					<div class="divLinhaCadastro"
						...
						<div class="divItemGrupo" style="width: 70%; height: 20px">
							<p>Credito:</p>
							<s:textfield style="width: 550px;" onblur="getCredito(this, 'recDraEjb.credito')"
			...
			<div class="divGrupo" style="width: 98%; height: 102px">
				...
				<s:if
					...
					<div class="divLinhaCadastro"
						...
						<div class="divItemGrupo" style="width: 70%; height: 20px">
							<p>Débito:</p>
							<s:textfield style="width: 550px;" onblur="getDebito(this, 'recPisEjb.debito')"
						...
						<div class="divItemGrupo" style="width: 20%; height: 20px">
							<s:checkbox name="recPisEjb.pis"
								id="recPisEjb.pis">PIS</s:checkbox>
						</div>
						<div class="divItemGrupo" style="width: 100%; height: 20px">
							<p>Centro de Custo</p>
							<s:select cssClass="width:80%;" list="#session.centroCustoList"
				...
				<s:if test="%{hashDsClassificacaoContabil['REC_PIS'][1].indexOf('C')!=-1}">
					...
					<div class="divLinhaCadastro"
						...
						<div class="divItemGrupo" style="width: 70%; height: 20px">
							<p>Credito:</p>
							<s:textfield style="width: 550px;" onblur="getCredito(this, 'recPisEjb.credito')"
			...
			<div class="divGrupo" style="width: 98%; height: 102px">
				...
				<s:if
					...
					<div class="divLinhaCadastro"
						...
						<div class="divItemGrupo" style="width: 70%; height: 20px">
							<p>Débito:</p>
							<s:textfield style="width: 550px;" onblur="getDebito(this, 'recCofEjb.debito')"
						...
						<div class="divItemGrupo" style="width: 20%; height: 20px">
							<s:checkbox name="recCofEjb.pis"
								id="recCofEjb.pis">PIS</s:checkbox>
						</div>
						<div class="divItemGrupo" style="width: 100%; height: 20px">
							<p>Centro de Custo</p>
							<s:select cssClass="width:80%;" list="#session.centroCustoList"
				...
				<s:if
					...
					<div class="divLinhaCadastro"
						...
						<div class="divItemGrupo" style="width: 70%; height: 20px">
							<p>Credito:</p>
							<s:textfield style="width: 550px;" onblur="getCredito(this, 'recCofEjb.credito')"
			...
			<div class="divGrupo" style="width: 98%; height: 102px">
				...
				<s:if
					...
					<div class="divLinhaCadastro"
						...
						<div class="divItemGrupo" style="width: 70%; height: 20px">
							<p>Débito:</p>
							<s:textfield style="width: 550px;" onblur="getDebito(this, 'recCsslEjb.debito')"
						...
						<div class="divItemGrupo" style="width: 20%; height: 20px">
							<s:checkbox name="recCsslEjb.pis"
								id="recCsslEjb.pis">PIS</s:checkbox>
						</div>
						<div class="divItemGrupo" style="width: 100%; height: 20px">
							<p>Centro de Custo</p>
							<s:select cssClass="width:80%;" list="#session.centroCustoList"
				...
				<s:if
					...
					<div class="divLinhaCadastro"
						...
						<div class="divItemGrupo" style="width: 70%; height: 20px">
							<p>Credito:</p>
							<s:textfield style="width: 550px;" onblur="getCredito(this, 'recCsslEjb.credito')"
			...
			<div class="divGrupo" style="width: 98%; height: 102px">
				...
				<s:if
					...
					<div class="divLinhaCadastro"
						...
						<div class="divItemGrupo" style="width: 70%; height: 20px">
							<p>Débito:</p>
							<s:textfield style="width: 550px;" onblur="getDebito(this, 'recIrrfEjb.debito')"
						...
						<div class="divItemGrupo" style="width: 20%; height: 20px">
							<s:checkbox name="recIrrfEjb.pis"
								id="recIrrfEjb.pis">PIS</s:checkbox>
						</div>
						<div class="divItemGrupo" style="width: 100%; height: 20px">
							<p>Centro de Custo</p>
							<s:select cssClass="width:80%;" list="#session.centroCustoList"
				...
				<s:if
					...
					<div class="divLinhaCadastro"
						...
						<div class="divItemGrupo" style="width: 70%; height: 20px">
							<p>Credito:</p>
							<s:textfield style="width: 550px;" onblur="getCredito(this, 'recIrrfEjb.credito')"
			...
			<div class="divGrupo" style="width: 98%; height: 102px">
				...
				<s:if
					...
					<div class="divLinhaCadastro"
						...
						<div class="divItemGrupo" style="width: 70%; height: 20px">
							<p>Débito:</p>
							<s:textfield style="width: 550px;" onblur="getDebito(this, 'recIssEjb.debito')"
						...
						<div class="divItemGrupo" style="width: 20%; height: 20px">
							<s:checkbox name="recIssEjb.pis"
								id="recIssEjb.pis">PIS</s:checkbox>
						</div>
						<div class="divItemGrupo" style="width: 100%; height: 20px">
							<p>Centro de Custo</p>
							<s:select cssClass="width:80%;" list="#session.centroCustoList"
				...
				<s:if
					...
					<div class="divLinhaCadastro"
						...
						<div class="divItemGrupo" style="width: 70%; height: 20px">
							<p>Credito:</p>
							<s:textfield style="width: 550px;" onblur="getCredito(this, 'recIssEjb.credito')"

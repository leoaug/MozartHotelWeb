...
<script>
 ...
 <!-- grid -->     
    <duques:grid colecao="listaPesquisa" titulo="Relatório de camareira" 
        ...
        <duques:column labelProperty="Cód. Do Registro"         	propertyValue="idCamareira"   style="width:100px;"/>

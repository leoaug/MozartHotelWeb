...
<script type="text/javascript">
            ...
            function cancelar(){
        		...
        		vForm.action = '<s:url action="pesquisarVendedorRede!preparar.action" namespace="/app/vendedor" />';
        		submitForm(vForm);
            }
            ...
            function validarEmpresa(cnpj){
            	...
            	if($("#opcoes").val() == '3'){
            		vForm = document.forms[0];
	        		vForm.action = '<s:url action="manterVendedor!validarEmpresa.action" namespace="/app/vendedor" />';
	        		submitForm(vForm);
            	}
...
<s:form namespace="/app/vendedor" action="manterVendedor!gravar.action" theme="simple">
...
<div class="divFiltroPai" >       
       <div class="divCadastro" style="overflow:auto;" >
			  ...
			  <s:if test="%{!cadastrarEmpresa}">
					...
					<div class="divGrupoTitulo">Dados do Vendedor</div>

...
<script>
 ...
 <!-- grid -->
    ...
    <duques:grid colecao="listaPesquisa" titulo="Relatório de Config Fnrh" 
    			 condicao="" 
    			 current="obj" 
        ...
        <duques:column labelProperty="Título"				       	propertyValue="titulo"					style="width:250px;"/>
        <duques:column labelProperty="Descrição"			       	propertyValue="descricao"				style="width:500px;" />

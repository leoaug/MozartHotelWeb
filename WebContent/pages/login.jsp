...
<s:form action="/login!logar.action" theme="simple" id="login_form"
    ...
    <h1>Mensagem:</h1>
    <img src="imagens/iconic/png/check-3x.png" />
	...
	<div class="divBemVindo">
		<div class="divBemVindoLeft">
			<table style="height: 100%; width: 100%; margin-left: 30px;">
				<tr>
					<td>
						<h2>Login</h2>
						<div class="input-group form-group loginText">
							...
							<s:textfield cssClass="form-control" cssStyle="text-transform: uppercase; max-width: 50%;" onblur="this.value = this.value.toUpperCase();" name="login" />
						</div>
						<div class="input-group form-group loginText">
							<div class="input-group-prepend">
								<span class="input-group-text"><img src="imagens/iconic/png/key-2x.png" ></img></span>
							</div>
							<s:password cssClass="form-control" cssStyle="max-width: 50%;" id="senha" name="senha" />
						</div>
						<div class="form-group">
							<button type="button" onclick="autenticar()" class="btn btn-primary" <s:if test="%{cssColor != null && cssColor != ''}">style="background-color:#${cssColor}"</s:if>>Login</button>
						</div>
					</td>
				</tr>
			</table>
		</div> 
		<div class="divBemVindoRight" <s:if test="%{cssColor != null && cssColor != ''}">style="background-color:#${cssColor} !important; text-align: center;"</s:if>>
			<table style="height: 100%; width: 100%;"><tr><td><img style="cursor:initial;" src="data:image/png;base64,${imgBase}" /></td></tr></table>
		</div>
	</div>
</s:form>

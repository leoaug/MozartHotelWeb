...
public class FactoryRemessaBancoob extends AbstractFactoryRemessa{

	public FactoryRemessaBancoob(String padraoCNAB) {
		padraoCNABAtivo = new HashMap<String, String>();
		padraoCNABAtivo.put(PADRAO_CNAB_400, "LayoutBancoobCNAB400Envio.txg.xml");
	...
	protected Record createHeader(FlatFile<Record> ff) {
		...
		header.setValue("CodigoDaEmpresa", contaCorrente.getBancoEJB().getNumeroBanco());
